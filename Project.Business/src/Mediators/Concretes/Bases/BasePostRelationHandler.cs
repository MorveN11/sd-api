...
{
    public abstract class BasePostRelationHandler<
        TFirstEntity,
        TSecondEntity,
        TRequest,
        TRepository
    ...
    {
        protected BasePostRelationHandler(TRepository repository, LogHandler logger)
        ...
        {
            return await Repository.AddRelation(firstEntityId, secondEntityId);
        }
    }
}
