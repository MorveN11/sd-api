...
// using Project.Business.Mediators.Students.Delete;
// using Project.Business.Mediators.Students.Get;
// using Project.Business.Mediators.Students.Post;
// using Project.Business.Mediators.Students.Put;
...
namespace Project.Test.Handlers
{
    ...
    public class StudentTests
    {
        ...
        //     var handler = new GetStudentCareersHandler(mockRepository.Object, new LogHandler());
        //
        ...
        //     var handler = new GetStudentByIdHandler(mockRepository.Object, new LogHandler());
        //
        //     var result = await handler.Handle(request, CancellationToken.None);
        //
        //     Assert.That(result, Is.Not.Null);
        ...
        //     var handler = new DeleteStudentByIdHandler(mockRepository.Object, new LogHandler());
        //
        //     var result = await handler.Handle(request, CancellationToken.None);
        //
        ...
        //     var handler = new PutStudentHandler(mockRepository.Object, new LogHandler());
        //
        //     var result = await handler.Handle(request, CancellationToken.None);
        //
        //     Assert.That(result, Is.EqualTo(1));
